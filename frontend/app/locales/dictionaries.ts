...
export const dictionaries = {
  pt: {
    ...
    form: {
      ...
      dropzoneDefaultSubtitle: "MP4 ou MOV (30 segundos)",
    ...
    results: {
      ...
      dimensionsTitle: "Detalhamento Técnico",
      eyeContact: "Contato Visual",
      facialExp: "Expressividade Facial",
      prosody: "Variação de Prosódia",
      dimHelpEye: "Mede a atenção direcionada no olhar durante as interações.",
      dimHelpExp: "Analisa reações afetivas ligadas à interações sociais no vídeo.",
      dimHelpAud: "Avalia a entonação na resposta auditiva e chamados vocais.",
  ...
  en: {
    ...
    form: {
      ...
      dropzoneDefaultSubtitle: "MP4 or MOV (30 seconds)",
    ...
    results: {
      ...
      copyLink: "Copy Link",
      downloadPDF: "Download PDF",
      dimensionsTitle: "Technical Detail",
      eyeContact: "Eye Contact",
      facialExp: "Facial Expressivity",
      prosody: "Prosody Variation",
      dimHelpEye: "Measures directed gaze attention during interactions.",
      dimHelpExp: "Analyzes affective reactions linked to social interactions in the video.",
      dimHelpAud: "Evaluates intonation in auditory response and vocal calls.",
  ...
  es: {
    ...
    form: {
      ...
      dropzoneDefaultSubtitle: "MP4 o MOV (30 segundos)",
    ...
    results: {
      ...
      dimensionsTitle: "Detalle Técnico",
      eyeContact: "Contacto Visual",
      facialExp: "Expresividad Facial",
      prosody: "Variación de Prosodia",
      dimHelpEye: "Mide la atención dirigida en la mirada durante las interacciones.",
      dimHelpExp: "Analiza reacciones afectivas ligadas a interacciones sociales en el video.",
      dimHelpAud: "Evalúa la entonación en respuesta auditiva y llamadas vocales.",
