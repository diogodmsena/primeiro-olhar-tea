...
export const dictionaries = {
  pt: {
    ...
    form: {
      ...
      btnNextShort: "Próximo",
      btnViewGuide: "Ver Guia",
      childNamePlaceholder: "Nome da criança",
      videoReady: "Vídeo Pronto para Envio",
      videoRemove: "Remover e Escolher Outro",
      videoRecord: "Gravar Vídeo Agora",
      videoPickGallery: "Escolher da Galeria",
      guideTitle: "Guia de Gravação",
      guideDismiss: "Entendi",
      guideFramingTitle: "Enquadramento",
      guideFramingDesc: "Mantenha a câmera na altura dos olhos da criança, a cerca de 1 metro.",
      guideInteractionTitle: "Interação",
    ...
    report: {
      ...
      resultAvailable: "Avaliação Preliminar",
      ...
      auditory: "Prosódia",
      radarChartTitle: "Perfil Multimodal",
      aiReportTitle: "Resultado da Triagem",
  ...
  en: {
    ...
    form: {
      ...
      videoReady: "Video Ready to Submit",
      videoRemove: "Remove and Choose Another",
      videoRecord: "Record Video Now",
      videoPickGallery: "Choose from Gallery",
      guideTitle: "Recording Guide",
      guideDismiss: "Got it",
      guideFramingTitle: "Framing",
      guideFramingDesc: "Keep the camera at the child's eye level, about 1 meter away.",
      guideInteractionTitle: "Interaction",
    ...
    report: {
      ...
      auditory: "Prosody",
      radarChartTitle: "Multimodal Profile",
  ...
  es: {
    ...
    form: {
      ...
      btnNextShort: "Siguiente",
      btnViewGuide: "Ver Guía",
      childNamePlaceholder: "Nombre del niño/a",
      videoReady: "Video Listo para Enviar",
      videoRemove: "Quitar y Elegir Otro",
      videoRecord: "Grabar Video Ahora",
      videoPickGallery: "Elegir de la Galería",
      guideTitle: "Guía de Grabación",
      guideDismiss: "Entendido",
      guideFramingTitle: "Encuadre",
      guideFramingDesc: "Mantén la cámara a la altura de los ojos del niño/a, a unos 1 metro.",
      guideInteractionTitle: "Interacción",
